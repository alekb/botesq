...
export function LogoMark({ className }: LogoMarkProps) {
  return (
    ...
    >
      ...
      {/* Balance scale beam */}
      <rect x="4" y="14" width="24" height="2" rx="1" fill="url(#logoGradient)" />

      {/* Center pillar */}
      <rect x="15" y="12" width="2" height="16" rx="1" fill="url(#logoGradient)" />

      {/* Base */}
      <rect x="10" y="26" width="12" height="2" rx="1" fill="url(#logoGradient)" />
      ...
      <circle cx="16" cy="10" r="3" fill="url(#logoGradient)" />
