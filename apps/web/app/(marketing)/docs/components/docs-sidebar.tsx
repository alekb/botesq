...
const navigation: NavItem[] = [
  ...
  { title: 'Authentication', href: '/docs/authentication' },
  {
    ...
    items: [
      ...
      { title: 'ask_legal_question', href: '/docs/tools/ask-legal-question' },
      { title: 'create_matter', href: '/docs/tools/create-matter' },
      { title: 'get_matter_status', href: '/docs/tools/get-matter-status' },
      { title: 'list_matters', href: '/docs/tools/list-matters' },
      { title: 'get_retainer_terms', href: '/docs/tools/get-retainer-terms' },
      { title: 'accept_retainer', href: '/docs/tools/accept-retainer' },
      { title: 'submit_document', href: '/docs/tools/submit-document' },
      { title: 'get_document_analysis', href: '/docs/tools/get-document-analysis' },
      { title: 'request_consultation', href: '/docs/tools/request-consultation' },
      { title: 'get_consultation_result', href: '/docs/tools/get-consultation-result' },
    ],
  },
